...
import (
	...
	"github.com/michain-org/hspeed-sdk-go/internal/github.com/hyperledger/fabric/sdkpatch/cryptosuitebridge"
...
func ComputeSM3(data []byte) (hash []byte) {
	hash, err := cryptosuitebridge.GetDefault().Hash(data, &bccsp.SM3Opts{})
	if err != nil {
