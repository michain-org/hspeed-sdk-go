...
import (
	...
	"github.com/michain-org/hspeed-sdk-go/pkg/core/logging/metadata"
)
...
func hasLoggerFnPrefix(pkgPath string, fnName string) bool {
	const (
		loggingAPIPath = "github.com/michain-org/hspeed-sdk-go/pkg/core/logging/"
		loggingAPIPkg  = "api" // Go < 1.12
		modlogFnPrefix = "modlog.(*Log)."
		loggingPath    = "github.com/michain-org/hspeed-sdk-go/pkg/common/"
		loggingPkg     = "logging"
		logBridgePath  = "github.com/michain-org/hspeed-sdk-go/internal/github.com/hyperledger/fabric-ca/sdkpatch/logbridge"
